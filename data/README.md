...
Introducing my latest project: Email Genie! I’ll be exploring different machine learning methods in an attempt to classify and group emails based on their content.

In Part 1 of this blog series, I share steps I took to load and clean the data data loading, preparing the email dataset for vectorisation and machine learning.
